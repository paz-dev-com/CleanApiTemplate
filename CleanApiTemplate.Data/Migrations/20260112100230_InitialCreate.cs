...
{
    private static readonly string[] _columns = ["UserId", "RoleId"];
    private static readonly string[] _columnsArray = ["CategoryId", "IsActive"];
    private static readonly string[] _columnsArray0 = ["EntityName", "EntityId", "PerformedAt"];
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateIndex(
            ...
            table: "AuditLogs",
            columns: _columnsArray0);

        migrationBuilder.CreateIndex(
            name: "IX_Products_CategoryId_IsActive",
            table: "Products",
            columns: _columnsArray);
